...
public class Vortex_Controller : MonoBehaviour
{
    ...
    private Material matVortexInstance, matVortexInstance2, matRocksInstance;
    ...
    private void Awake()
    {
        ...
        matVortexInstance2 = meshRenderers[1].GetComponent<Renderer>().material;//sandpit
        matVortexInstance2.SetColor("_EmissionColor", effectsColor);
        matVortexInstance2.SetFloat("_EmissionStrength", 0);
    ...
    private IEnumerator TransitionSequence()
    {
        ...
        while (true)
        {
            ...
            matVortexInstance2.SetFloat("_EmissionStrength", fadeFloat * 0.4f);
