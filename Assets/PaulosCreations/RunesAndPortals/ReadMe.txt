...
Version : 
5.1 Added a colorfull shader version
5.0 Added 3 new models, added the option to change colors easily.

4.0 Added a round floating Portal
...
To Start/Stop the effect just call "Toggle`RuneStone`(bool _activate)" on the  "Controller" Scripts;
